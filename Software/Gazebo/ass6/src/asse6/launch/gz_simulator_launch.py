...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('asse6')
    world = os.path.join(bringup_dir , "world", "depot.sdf")

    # Use URDF instead of SDF for robot_state_publisher
    urdf_file_path = os.path.join(bringup_dir, 'urdf', 'Ensamblajefullv6.urdf')
    ...
    # Spawn the robot in Gazebo from URDF via /robot_description topic
    spawn_entity = Node(
        package="ros_gz_sim",
        executable="create",
        arguments=[
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('urdf_file',default_value=os.path.join(bringup_dir, 'urdf', 'Ensamblajefullv6.urdf'),description='Whether to start RVIZ'),
